...
const Draw = ({texts, setSelectedPath }) => {
    ...
    const varChange = (e) => {  
    // fetch(`http://localhost:3000/monkey_pictures/pictures/${texts[e.target.value]}.txt`)
    fetch(`http://localhost:3000/monkey_pictures/pictures.txt`)
