...
const Monkey = () => {
    ...
    const [selectedPath, setSelectedPath] = useState('http://localhost:3000/monkey_pictures/picture15.txt');
    ...
    fetch(`http://localhost:3000/default_picture.txt`)
          ...
          .then(data_default_picture => {
            ...
            const url = `http://localhost:3000/monkey_pictures/picture15.txt`
            setSelectedPath(url)
          })
        }, []);
